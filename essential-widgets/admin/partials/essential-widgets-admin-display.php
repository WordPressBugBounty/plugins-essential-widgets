                        ...
                        <div class="content">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <?php $ctp_options = ctp_get_options(); // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound -- Used immediately below; ctp_ prefix kept for cross-plugin compatibility. ?>
                ...
                <div id="premium-extensions" class="wpcatchtab  save">
                    ...
                    <div class="about-text">
                        ...
                        <p><?php esc_html_e('You are currently using the free version of Essential Widgets.', 'essential-widgets'); ?><br />
                            <a href="https://catchplugins.com/plugins/" target="_blank"><?php esc_html_e('If you have purchased from catchplugins.com, then follow this link to the installation instructions (particularly step 1).', 'essential-widgets'); ?></a>
                        </p>
                    </div>
                            ...
                            <table class="widefat fixed striped posts">
                                ...
                                <tbody id="the-list" class="ui-sortable">
                                    <tr class="iedit author-self level-0 type-post status-publish format-standard hentry">
                                        ...
                                        <td class="column column-free">
                                            <div class="table-icons icon-green">&#10003;</div>
                                        </td>
                                        <td class="column column-pro">
                                            <div class="table-icons icon-green">&#10003;</div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="iedit author-self level-0 type-post status-publish format-standard hentry">
                                        ...
                                        <td class="column column-free">
                                            <div class="table-icons icon-red">&#215;</div>
                                        </td>
                                        <td class="column column-pro">
                                            <div class="table-icons icon-green">&#10003;</div>
                                        </td>
